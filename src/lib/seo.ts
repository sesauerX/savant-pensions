...
export const pages: Record<string, PageSeo> = {
  "/": {
    crumb: "Home",
    title: "Pension Plan Administrator for Business Owners | Savant Pensions",
    description:
      "Savant Pensions is a pension plan administrator for business owners. We design and administer Defined Benefit and Cash Balance plans.",
  },
  "/defined-benefit": {
    crumb: "Defined Benefit",
    title: "Defined Benefit Plans for Business Owners | Savant Pensions",
    description:
  ...
  "/cash-balance": {
    crumb: "Cash Balance",
    title: "Cash Balance Plans for Business Owners | Savant Pensions",
    description:
  ...
  "/services": {
    crumb: "Services",
    title: "Pension Plan Administration Services | Savant Pensions",
    description:
      "Plan design, third-party administration, and compliance support for Defined Benefit and Cash Balance plans. Savant is not the actuary.",
  },
  "/about": {
    crumb: "About",
    title: "About Savant Pensions, Plan Administrator",
    description:
      "Savant Pensions LLC is an independent third-party administrator for Defined Benefit and Cash Balance plans, based in West Hartford, Connecticut.",
  },
  "/contact": {
    crumb: "Contact",
    title: "Contact a Pension Plan Administrator | Savant Pensions",
    description:
      "Talk with Savant Pensions about Defined Benefit or Cash Balance administration. Call (860) 590-7172 or send compensation and a census.",
  },
  "/insights": {
    crumb: "Insights",
    title: "Pension Insights for Business Owners | Savant Pensions",
    description:
  ...
  "/staff-cost": {
    crumb: "Staff cost",
    title: "Cash Balance Plan Staff Cost | Savant Pensions",
    description:
  ...
  "/calendar": {
    crumb: "Deadlines",
    title: "Pension Plan Deadline Calendar | Savant Pensions",
    description:
  ...
  "/fees": {
    crumb: "Fees",
    title: "Pension Plan Administration Fees | Savant Pensions",
    description:
  ...
  "/plan-lifecycle": {
    ...
    title: "After the Cash Balance Plan Exists | Savant Pensions",
    description:
  ...
  "/calculator": {
    crumb: "Calculator",
    title: "Cash Balance Contribution Calculator | Savant Pensions",
    description:
  ...
  "/faq": {
    crumb: "FAQs",
    title: "Cash Balance and Defined Benefit FAQs | Savant Pensions",
    description:
  ...
  "/administration": {
    ...
    title: "Third-Party Pension Administration | Savant Pensions",
    description:
  ...
  "/privacy": {
    crumb: "Privacy",
    title: "Privacy Policy | Savant Pensions",
    description:
      "What Savant Pensions collects on this website, why we collect it, who we share it with, and how to ask for a correction or deletion.",
  },
  "/terms": {
    crumb: "Terms of Use",
    title: "Terms of Use | Savant Pensions",
    description:
      "Terms of Use for the Savant Pensions website, including what the site is, what it is not, and the limits on reliance before an engagement.",
  },
  "/disclaimer": {
    crumb: "Disclaimer",
    title: "Website Disclaimer | Savant Pensions",
    description:
      "Savant Pensions is not a law firm, CPA firm, or actuarial firm. Illustrations are not IRS limits, quotes, or deductible contributions.",
  },
  "/support": {
    crumb: "Client support",
    title: "Client Support | Savant Pensions",
    description:
      "Reach Savant Pensions about an existing retirement plan or a new Defined Benefit or Cash Balance administration question.",
  },
};
