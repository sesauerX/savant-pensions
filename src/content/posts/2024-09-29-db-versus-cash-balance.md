---
title: "Traditional defined benefit versus cash balance for a solo owner in 2024"
date: 2024-09-29
kicker: Owner briefing
description: "Both are defined benefit plans under the same 2024 benefit limit; the difference is how the promise is written and how an owner has to live with it."
image: /images/briefing/2024-09-29.jpg
slug: db-versus-cash-balance
---
...
[Publication 560](https://www.irs.gov/publications/p560) describes both families of plans without picking a winner. Use it as orientation. Use the actuary for the number.
...
PBGC coverage is plan-specific. A one-person professional practice is often outside coverage because of the professional-service employer rules, and often is not, depending on facts the statute actually uses. Many small professional-service employers are exempt. It is not true that all small plans are exempt, and it is not true that a consultant who might hire a first employee next year can ignore the question. Hiring changes the census and can change coverage. Read the agency's [coverage guidance](https://www.pbgc.gov/prac/other-guidance/coverage) with counsel before you treat exemption as a feature of the cash balance label. The label is irrelevant. The employer and the plan are what matter.

Both plans are real enough to terminate only with care. A solo owner who expects to sell within two years should read [/insights/not-a-fit](/insights/not-a-fit) before choosing the friendlier of the two formulas. A friendlier statement does not make a short-lived pension a good idea. Ongoing administration, a trust, a valuation, and a Form 5500 filed on EFAST2 are part of either choice. For a calendar-year plan the Form 5500 is generally due **July 31**, extendable to **October 15** with Form 5558. The IRS overview is the [Form 5500 corner](https://www.irs.gov/retirement-plans/form-5500-corner). Budget for that work on the [fees](/fees) page rather than discovering it as an annoyance after the deduction has been spent in your head.
