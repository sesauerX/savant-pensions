---
title: "The employee census decides the plan, not a slogan"
date: 2024-10-13
kicker: Owner briefing
description: "Coverage, compensation, and related employers decide whether a 2024 cash balance design works, long before anyone quotes a contribution."
image: /images/briefing/2024-10-13.jpg
slug: census-first
---
...
Any owner contribution attached to that census before a valuation is **illustrative**. The **$275,000** benefit limit is not the credit. Two owners with the same capped compensation and different ages will not have the same **illustrative** credit, and two owners with the same age and different staff lists will not either. The IRS benefit-limit overview is here: [retirement topics, defined benefit limits](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-defined-benefit-plan-benefit-limits). [Publication 560](https://www.irs.gov/publications/p560) is the small-employer booklet that sits underneath the slogans.

## What the actuary and the administrator each do with the list

The enrolled actuary tests and values. Savant, as administrator, keeps the list consistent with payroll, with the document's eligibility rules, and with the Form 5500 counts you will eventually sign. Those counts are not a creative exercise. A calendar-year Form 5500 is generally due **July 31**, extendable to **October 15** with Form 5558, and it is filed on EFAST2. The Department of Labor's filing guidance is here: [Form 5500 reporting](https://www.dol.gov/agencies/ebsa/employers-and-advisers/plan-administration-and-compliance/reporting-and-filing/form-5500). The IRS companion page is the [Form 5500 corner](https://www.irs.gov/retirement-plans/form-5500-corner). You are not filing in October. You are building the census that will make a later filing true.

If the census shows a staff cost you will not pay, the plan is [not a fit](/not-a-fit). That is a successful use of the list. If the census shows a cost you will pay, the design can proceed toward a document, and the funding dates still have to stay distinct. Minimum funding for a calendar-year defined benefit plan is generally due **September 15** of the next year, **8.5 months** after year-end. A missed minimum can mean a **10%** excise tax on Form 5330. The deduction often follows the return due date including extensions under IRC 404(a)(6). Your CPA confirms the deduction date. The census does not change those clocks. It changes whether you should start them.

PBGC coverage is also a census question of a kind. Many small professional-service employers are exempt. Exemption is plan-specific, and it is not granted to every small employer. A census that grows can change the analysis. Do not write "PBGC exempt" in the margin because the practice feels small. The [fees](/fees) and [plan lifecycle](/plan-lifecycle) pages assume you will ask the coverage question rather than inherit an answer from a slogan.
...
The [illustrations](/illustrations) on this site are teaching ranges. They are not your census. The [calculator](/calculator) is the same kind of tool. Bring them to a meeting if they help you ask better questions. Do not bring them as the census.
...
- If staff costs are acceptable, ask for a design that uses the real list under the 2024 limits, including the **$275,000** benefit limit as a benefit limit only. If they are not acceptable, stop and read [when it is not a fit](/not-a-fit).
- If anyone should still defer for 2024, tell payroll this week. The census project does not extend the deferral clock.

When the register is complete, [contact Savant Pensions](/contact). Send the census. Do not send a target deposit and ask us to make the people fit the target.
