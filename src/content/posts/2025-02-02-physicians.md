---
title: "Medical practices: the staff math that makes or breaks a design"
date: 2025-02-02
kicker: Owner briefing
description: "A physician-owner's cash balance credit is only as real as the clinical payroll the tests have to include."
image: /images/briefing/2025-02-02.jpg
slug: physicians
---
...
The general method for building the list is [/insights/census-first](/insights/census-first). Dental offices have a cousin of this problem, hygienists instead of a clinical floor, written up in [/insights/dentists](/insights/dentists). The legal test is the same family of tests. The payroll shape is not identical, so do not borrow a dentist's **illustrative** staff percentage and apply it to a medical group.
...
Bring the entity chart to the first meeting. Ownership percentages, including family attribution your counsel says applies, belong on it. If you are unwilling to show a related payroll because it "ruins the numbers," the numbers were never yours. The plan is [not a fit](/not-a-fit) until you can look at the combined list and still want the promise. That is a respectable outcome. Many strong practices should keep a 401(k), use the **$23,500** deferral and the applicable catch-up, and stop there.

## How the dollars usually have to be split

Where a design works, it is often a [401(k) paired with a cash balance plan](/combo), not a pension alone. The 401(k) holds deferrals and a profit-sharing contribution that can be part of how staff benefits are delivered. The cash balance plan holds the physician's larger credit, if testing allows it. "If" is the load-bearing word. The actuary, not a brochure about combo plans, says whether a particular split passes. The reason pairs are common is [/insights/combo-plan](/insights/combo-plan). Common is not automatic.
...
[Publication 560](https://www.irs.gov/publications/p560) is worth handing to a physician who has only ever had a SEP. It will not compute the staff test. It will keep the vocabulary from collapsing into "the retirement plan."
