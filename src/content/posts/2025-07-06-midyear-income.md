---
title: "July is when the illustration meets the payroll."
date: 2025-07-06
kicker: Owner briefing
description: "Half of 2025 is over. Compare the compensation in the illustration to the compensation you are actually paying."
image: /images/briefing/2025-07-06.jpg
slug: midyear-income
---
...
Savant Pensions is a third-party administrator in West Hartford. We can put the midyear census next to the illustration. We do not certify the contribution. An independent Enrolled Actuary does. We are not an actuarial firm, and this briefing is not tax, legal, or actuarial advice.
...
For an S corporation, the column that matters is W-2 wages. Distributions do not belong in it. A shareholder who is "on pace" for a large K-1 and a small wage is on pace for a small plan, no matter what the January sketch said when someone typed total income into the compensation field. The [briefing on that distinction](/insights/scorp-wages) is the longer version. The July version is a single instruction: if the wage will not reach the figure in the illustration, the illustration is already stale.
...
For a sole proprietor, the Schedule C is the source, and half a year of book income is a draft. Owner's draws are not wages and not a salary you can point to. A [self-employed design](/self-employed) that was illustrated on last year's net profit needs this year's profit, year to date, before anyone repeats the contribution figure in a conversation with the CPA.
...
Defined contribution limits do not rescue a stale illustration, but they bound the 401(k) piece. For 2025 the elective deferral limit is **$23,500**. The catch-up is **$7,500**, or **$11,250** if the participant attains age 60, 61, 62, or 63 this year. The higher catch-up is instead of the **$7,500**, not in addition. Annual additions other than catch-up are limited to **$70,000**. An IRA, separate from the plan, is **$7,000**. The defined benefit dollar limit remains an annual benefit of **$280,000**, not a deposit. The IRS published these figures in [IR-2024-285](https://www.irs.gov/newsroom/401k-limit-increases-to-23500-for-2025-ira-limit-remains-7000) and maintains them on the [COLA page](https://www.irs.gov/retirement-plans/cola-increases-for-dollar-limitations-on-benefits-and-contributions). The benefit limit's reductions for age and service are described on the IRS [benefit limits page](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-defined-benefit-plan-benefit-limits). [Publication 560](https://www.irs.gov/publications/p560) is the small-employer overview. None of those pages knows your year-to-date payroll. The [limits page](/limits) states the same 2025 figures without turning them into a contribution promise.

If the year is better than the illustration, July is also the month to say so. A larger wage can support a larger credit only if the formula, the tests, and the timing allow it. Raising a formula for a year is an amendment that has to be adopted before the accrual you want to increase. A better year discovered in December is often a year you can profit-share into a defined contribution plan, if that plan's formula is discretionary, and cannot pour into a pension credit that was written too small. The [calculator](/calculator) can help you see the tax shape of a deposit. It cannot see your payroll, and it is not a valuation.
...
Bring actual year-to-date numbers, not a narrative. "A bit soft" is not a census. A payroll report is a census. The [illustrations](/illustrations) you already have can stay on the table as the hypothesis. The new page is the evidence. Where they differ, the evidence wins, and the hypothesis gets rerun.
...
If the 2025 columns do not match, ask for a revised illustration labeled as an illustration, using the pay you will actually hit. Then [send us the two columns](/contact). We would rather rerun a sketch in July than defend a January number against a W-2 in January.
